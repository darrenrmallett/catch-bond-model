...
for k4_UR in k4_list : 
    ...
    for k3_UR in k3_list:
        ...
        #send that list to the biphasic function to determine if it's biphasic or not.
        biphasic_result = biphasic( forces_and_lifetimes )

        k3_UR_str = str(k3_UR)
       
        #store the result of the score in a dictionary with keys corresponding to k4 and k3 unloaded rates.
        k3_k4_values[k4_UR_str][k3_UR_str] = biphasic_result
...
output += f'# This is using the MILLER WILD-TYPE DATA\n'
output += f'# Output: Biphasic = 1; not biphasic = 0'
...
filehandle = open('optimum_forces_MillerWT_vary_k3UR_and_k4UR.txt','w')
